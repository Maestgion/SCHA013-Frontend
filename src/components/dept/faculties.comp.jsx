      ...
      <section className="flex px-8 py-4 w-full">
        <div className="flex w-full justify-center gap-6">
          <div className="space-y-6 w-[76%]">
            ...
            <div class="relative overflow-x-auto shadow-lg rounded-lg h-[90%]">
              <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400 sticky top-0">
                  <tr>
                    <th scope="col" class="px-6 py-3 text-base rounded-l-lg">
                      Faculty
                    </th>
                    <th scope="col" class="px-6 py-3 text-base">
                      Class
                    </th>
                    <th scope="col" class="px-6 py-3 text-base rounded-r-lg">
                      Room No.
                    </th>
                  </tr>
                </thead>
                  ...
                  {new Array(10).fill().map((e) => {
                    return (
                      <tr class="bg-white dark:bg-gray-800">
                        ...
                        <td class="px-6 py-4">D1</td>
                        <td class="px-6 py-4">TP003</td>
                      </tr>
                    );
                  })}
                </tbody>
